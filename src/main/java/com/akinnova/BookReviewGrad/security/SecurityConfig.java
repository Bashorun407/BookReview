...
//                                .requestMatchers("/api/v1/auth/**").permitAll()
//                                .requestMatchers("/api/v1/comment/**").hasAnyRole("REGULAR_USER","ADMIN")
//                                .requestMatchers("/api/v1/project/**").hasRole("REGULAR_USER")
...
//                                .requestMatchers(HttpMethod.POST, "/api/v1/userEntity/auth/addUser").permitAll()
//                                .requestMatchers(HttpMethod.GET, "/api/v1/userEntity/auth/allUsers").hasAuthority("ADMIN")
//                                .requestMatchers(HttpMethod.GET, "/api/v1/userEntity/auth/clients").hasAnyAuthority("ADMIN", "REGULAR_USER")
//                                .requestMatchers(HttpMethod.GET, "/api/v1/userEntity/auth/providers").hasAnyAuthority("ADMIN", "REGULAR_USER")
//                                .requestMatchers(HttpMethod.GET, "/api/v1/userEntity/auth/admins").hasAuthority("ADMIN")
//                                .requestMatchers(HttpMethod.GET, "/api/v1/userEntity/auth/regularUsers").hasAuthority("ADMIN")
//                                .requestMatchers(HttpMethod.POST, "/api/v1/userEntity/auth/userUpdate").hasAnyAuthority("ADMIN", "REGULAR_USER")
//                                .requestMatchers(HttpMethod.PUT, "/api/v1/userEntity/auth/providerUpdate").hasAuthority("REGULAR_USER")
//                                .requestMatchers(HttpMethod.PUT, "/api/v1/userEntity/auth/roleUpdate").hasAuthority("ADMIN")
//                                .requestMatchers(HttpMethod.DELETE, "/api/v1/userEntity/auth/delete").hasAnyAuthority("ADMIN", "REGULAR_USER")
