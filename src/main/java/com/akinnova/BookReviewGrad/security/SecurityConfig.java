        ...
        httpSecurity
                ...
                .authorizeHttpRequests(authorize->
                        authorize.requestMatchers(HttpMethod.POST, "/api/v1/book/auth/(.*)").permitAll()
                                ...
                                .requestMatchers(HttpMethod.POST, "/api/v1/cart/auth/(.*)").permitAll()
                                .requestMatchers(HttpMethod.GET, "/api/v1/cart/auth/(.*)").permitAll()
                                .requestMatchers(HttpMethod.PUT, "/api/v1/cart/auth/(.*)").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/api/v1/cart/auth/(.*)").permitAll()
