...
//import static com.akinnova.BookReviewGrad.enums.RoleName.*;
...
//        RoleName role = roleRepository.findByRoleName(REGULAR_USER.toString()).orElseThrow(() ->
...
//            return new ResponsePojo<>(ResponseType.FAILED, String.format(ResponseUtils.USER_EXISTS, userCreateDto.getUsername()));
//        //throw new ApiException(String.format(ResponseUtils.USER_EXISTS, userCreateDto.getUsername()));
//        RoleName role = roleRepository.findByRoleName(ADMIN.toString()).orElseThrow(() ->
//                new IllegalArgumentException("Role with the provided name not found")
//        );
//        //Add and save new client to repository
//        UserEntity userEntity = userRepository.save(UserEntity.builder()
...
//        userEntity.setServiceProviderApplicationStatus(providerUpdateDto.getServiceProviderApplicationStatus());
//
